...
flowchart TD
    ...
    Stage1 --> Stage2["2. Design Gate: UI Designer (ui-ux-pro-max) -> DESIGN.md"]
...
- `DESIGN.md`: Mandatory design system specification extracted from `ui-ux-pro-max` at project root.
